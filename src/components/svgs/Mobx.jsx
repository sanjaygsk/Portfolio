...
const Mobx = (props) => (
  ...
  >
    ...
    />
    <path
      d="M127.277 125.38 241.963.806a19.6 19.6 0 0 0-5.57-.807H93.515z"
      fill="#e05e11"
    />
    <path
      d="M19.606 256h142.622l-34.951-130.621L8.499 252.549A19.5 19.5 0 0 0 19.606 256"
      fill="#de5c16"
    />
    <path
      d="M94.918 97.03h14.225c5.668 21.386 12.119 40.152 19.316 57.085 8.152-19.05 14.127-37.83 19.185-57.086h13.442c-6.02 23.926-15.868 48.04-27.132 72.93h-11.89c-10.82-23.586-20.03-47.837-27.146-72.93m-46.92-37.055h31.63v135.637h-31.77v-10.456H67.33V70.152H47.998zm160.169 10.177h-19.332v115.004h19.47v10.456h-31.769V59.975h31.63z"
      fill="#fff"
    />
  </svg>
);
